...
const require_versionSelector = require('./versionSelector-C0Tbx_s6.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.11.0");
